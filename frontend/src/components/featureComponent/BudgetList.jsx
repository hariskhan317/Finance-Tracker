  ...
  return (
    <div className='relative animate-card rounded-lg p-3 shadow-lg transition-all delay-0 ease-in-out'> 
        ...
        <div className='flex justify-between'> 
            ...
            <p style={{ color: `#${budget.color}` }} className='text-lg font-semibold text-center'>${budget.budgetAmount}</p>
          </div>
          <div className='py-4'>
            <ProgressBar 
          ...
          <div className='flex justify-between'>
            <p style={{ color: `#${budget.color}` }} className='text-sm font-medium'>spent  ...${budget.expenseAmount}</p>
            <p style={{ color: `#${budget.color}` }} className='text-sm font-medium'>remaining  ...${budget.budgetAmount - budget.expenseAmount }</p>
          </div>
        </div>
    </div>
  )
